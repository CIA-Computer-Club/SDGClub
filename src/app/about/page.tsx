...
export default function About() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <div className="text-3xl text-center p-24"> Meet our Admins</div>
      <div className="">
        ...
        <ProfileCard src="/assets/profile/rat.jpg" name="Rattanak Bun" title="Treasurer" quote={"''Making sure every cent is counted and finds its rightful place''"}></ProfileCard>
        
        <ProfileCard src="/assets/profile/woman1.jpg" name="Rathpidor Pheaseth" title="Secretary" quote={"''''"}></ProfileCard>
        
        <ProfileCard src="/assets/profile/woman2.jpg" name="Event Planner" title="Event Planner" quote={"''''"}></ProfileCard>
